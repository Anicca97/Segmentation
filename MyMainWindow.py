...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ptn_loadfolder = QtWidgets.QPushButton(self.centralwidget)
        self.ptn_loadfolder.setObjectName("ptn_loadfolder")
        self.gbox1.addWidget(self.ptn_loadfolder, 8, 2, 1, 1)
        ...
        self.menu_File.addAction(self.action_LoadFolder)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ptn_loadfolder.setText(_translate("MainWindow", "&Load Folder"))
        ...
        self.action_LoadFolder.setText(_translate("MainWindow", "&Load Folder"))
        self.action_LoadFolder.setShortcut(_translate("MainWindow", "L"))
